...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_TAB,  KC_Q,    KC_W,    LT(4, KC_E),    LT(5, KC_R),    KC_T,    KC_Y,    LT(6, KC_U),    LT(7, KC_I),    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL,
        KC_CAPS, LT(3, KC_A), LSFT_T(KC_S), LCTL_T(KC_D), LT(1, KC_F), KC_G, KC_H, LT(2, KC_J), RCTL_T(KC_K), RSFT_T(KC_L), KC_SCLN, KC_QUOT, KC_ENT, KC_PGUP,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_SYMBOL]      = {ENCODER_CCW_CW(_______, _______)},
    [_SYMBOL_MAIN]   = {ENCODER_CCW_CW(_______, _______)},
